...
const NewZealand: React.FC<Props> = ({ className }: Props) => (
<svg className={className} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="flag-icons-nz" viewBox="0 0 640 480" width="21" height="14">
  <defs>
    <g id="nz-b">
      <g id="nz-a">
        <path d="M0-.3v.5l1-.5z"/>
